          ...
          {(mode === 'login' || mode === 'signup') && !pendingVerification && (
            <div className="mt-8 space-y-6">
              ...
              <Button
                  ...
                  className="w-full h-11 rounded-xl border-neutral-200 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-950 hover:bg-neutral-100 dark:hover:bg-neutral-900 font-medium text-foreground transition-colors shadow-sm"
                >
